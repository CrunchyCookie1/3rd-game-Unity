...
namespace Christina.UI
{
    public class ToggleSwitch : MonoBehaviour, IPointerClickHandler
    {
        ...
        [SerializeField] private AudioClip onClikcSFX;
        ...
        {
            if (onClikcSFX != null && _audioSource != null)
                _audioSource.PlayOneShot(onClikcSFX);
            Toggle();
        }
        ...
        {
            SetStateAndStartAnimation(true);
        }

        public void ToggleOff()
        {
            SetStateAndStartAnimation(false);
        }
